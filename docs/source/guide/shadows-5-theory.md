...
One can prove that a single classical shadow (6) can correctly predict _any_ linear function in expectation, by taking average over the repeatedly $N$ independent classical shadows (7),
