...
As demonstrated in [How do I use ZNE ?](zne-1-intro.myst.md), the function {func}`.execute_with_zne()` applies both steps behind the scenes.
...
### Problem setup
We define a circuit and an executor, as shown in [How do I use ZNE?](zne-1-intro.myst.md).
...
one of the [built-in factories](zne-3-options.myst.md#extrapolation-methods-factory-objects).
