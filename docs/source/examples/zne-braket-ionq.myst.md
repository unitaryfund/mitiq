...
This tutorial shows an example of how to apply zero-noise extrapolation ([ZNE](../guide/zne.myst.md))
...
More details on the Mitiq notions of frontends and backends are given [here](../guide/frontends-backends.myst.md).
...
For information on how to define more advanced executors, see the [Executors](../guide/executors.myst.md) section of the Mitiq User Guide.
...
More details on ZNE options are given [here](../guide/zne-3-options.myst.md).
...
```{note}
Using a _batched_ executor could speedup this step, as explained in the [Executors](../guide/executors.myst.md) section.
```
+++
