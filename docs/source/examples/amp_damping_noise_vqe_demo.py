...
# # Mimic "define_noisy_gate" example 
damp_prob = 0.1
...
# program.define_noisy_gate("X", [0], append_kraus_to_gate([residual_kraus, damping_op], gate))


# # Usage as indicated in "define_noisy_gate" docstring
program.define_noisy_gate("X", [0], [residual_kraus, damping_op])
...
def executor(thetas, qc, ro, samples: int,
    ...
    # noisy.define_noisy_gate("X", [0], append_kraus_to_gate([residual_kraus, damping_op], gate))  
