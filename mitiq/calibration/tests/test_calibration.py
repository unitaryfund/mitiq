...
test_strategy_settings = Settings(
    ...
    strategies=[
        ...
        },
        {
            "technique": "zne",
            "scale_noise": fold_global,
            "factory": RichardsonFactory([1.0, 2.0]),
        },
    ],
    circuit_seed=1,
)
...
test_strategy_settings.make_circuits()

test_strategy_settings.make_strategies()

test_strategy_settings.make_strategies()[0].
