...
def _apply_cyclic_system_permutation(matrix: np.array, N_qubits: int, M: int=2) -> np.array:
    """
...
def _apply_symmetric_observable(matrix: np.array, N_qubits: int, observable: Optional[Observable] = None, M: int=2) -> np.array:
