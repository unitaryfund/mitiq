...
def execute_with_shadows(
        ...
        *,
        ...
        measurement_total_rounds: Optional[int] = None,  # Number of Total Measurements for calibration
    ...
    if error_rate is not None:
        if state_reconstruction:
            measurement_total_rounds = min_n_total_measurements(error_rate, num_qubits=num_qubits)
            K2 = 1
            ...
            measurement_total_rounds, K2 = calculate_shadow_bound(error=error_rate, observables=observables,
    ...
    '''
    shadow_outcomes, pauli_strings = shadow_measure_with_executor(circuit, executor,
