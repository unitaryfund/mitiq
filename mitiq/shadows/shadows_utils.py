...
# given error of the fidelity between the true state and the
# reconstructed state,return the number of measurements needed
...
def calculate_shadow_bound(
    ...
    Returns:
        An integer that gives the number of samples required to satisfy the
         shadow bound and the chunk size required attaining the specified
         failure rate.
    """
