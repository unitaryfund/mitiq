...
def execute_with_ddd(
    ...
    *,
    ...
    mitigated via the application of digital dynamical decoupling (DDD).
    ...
    Returns:
        ddd_value: The expectation value error-mitigated with DDD.
        ddd_data: A dictionary containing all the raw data involved in the
            DDD process (e.g. the circuit filled with DDD sequences).
...
def ddd_decorator(
    ...
    *,
    ...
    Returns:
        The DDD decorator to be applied to an executor function.
    """
