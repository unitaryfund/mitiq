...
import tests.test_qiskit_utils as tip
...
# result = execute_with_shots(circuit= qc, obs= None, shots=1024, simulation=True, machine_name="aer_simulator",IBMQ_ACCOUNT_TOKEN=None)
...
# result_new = execute_with_shots(circuit= qc, obs= None, shots=1024, simulation=True, machine_name="aer_simulator_stabilizer",IBMQ_ACCOUNT_TOKEN=None)
...
# result_new1 = execute_with_shots(circuit= qc, obs= None, shots=1024, simulation=True, machine_name="aer_simulator_statevector",IBMQ_ACCOUNT_TOKEN=None)
