...
| Dynamical decoupling                      |                                                                                                                                       |                                                                         | [9803057](https://arxiv.org/abs/quant-ph/9803057)<br>[1807.08768](https://arxiv.org/abs/1807.08768) | (Under development)      |
...
|------------------------------------------------|----------------------------------------------------|---------------------------------------------|-----------------------------------------------------------|
| ![Cirq frontend gif](docs/source/img/cirq.gif) | ![Qiskit frontend gif](docs/source/img/qiskit.gif) |                                             |                                                           |
