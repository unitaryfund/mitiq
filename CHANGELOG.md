...
- Update pyquil requirement from ~=3.3.2 to ~=3.3.3 (#1686) [@dependabot]
- Update qiskit requirement from ~=0.39.5 to ~=0.40.0 (#1687) [@dependabot]
...
- Update amazon-braket-sdk requirement from ~=1.35.2 to ~=1.35.3 (#1674) [@dependabot]
- Update qiskit requirement from ~=0.39.4 to ~=0.39.5 (#1675) [@dependabot]
...
- Update pennylane requirement from ~=0.27.0 to ~=0.28.0 (#1643) [@dependabot]
- Update cirq requirement from ~=1.0.0 to ~=1.1.0 (#1644) [@dependabot]
...
- Update scipy requirement from ~=1.9.3 to ~=1.10.0 (#1657) [@dependabot]
- update link (#1661) [@natestemen]
- Update amazon-braket-sdk requirement from ~=1.35.1 to ~=1.35.2 (#1656) [@dependabot]
- Update numpy requirement from ~=1.24.0 to ~=1.24.1 (#1652) [@dependabot]
